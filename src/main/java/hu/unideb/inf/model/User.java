...
public class User
{
    ...
    public User(UsersEntity entity) {
        this.username.setValue(entity.getUsername());
        this.fullName.setValue(entity.getFullName());
        this.email.setValue(entity.getEmail());
        this.dateOfBirth = entity.getDateOfBirth().toLocalDate();
        this.password.setValue(entity.getPword());
        this.balance.setValue(entity.getBalance()!= null ? entity.getBalance() : 10000);
    }
